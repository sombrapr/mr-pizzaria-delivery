  ...
  for (const raw of rawItems) {
    ...
    if (raw?.kind === "combo") {
      ...
      built.push({
        ...
        note: note || combo.description || "Combo em destaque"
      });
      continue;
    }
    ...
    if (raw?.kind === "promo_combo") {
      ...
      built.push({
        ...
        unit: 110,
        total: 110 * qty,
        note: note || "Inclui brotinha de chocolate com morango"
      });
      built.push({
        type: "product",
        category: "Promoções",
...
app.get("/", (_req, res) => res.status(200).send("Webhook da MR Pizzaria está online — versão 6.4.0."));
